...
The best overall test result is achieved by the CNN at the shortest sequence length (seq64), with a macro-F1 of 90.96\%. The LSTM reaches its best result at seq256 (90.74\%), indicating that it benefits more from longer input sequences, while the CNN performs best with shorter inputs. Both models show stable tuning and learning trajectories, with the Business class being the most challenging to classify.
