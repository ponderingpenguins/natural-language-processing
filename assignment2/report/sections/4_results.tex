...
Table~\ref{tab:tokenizer_coverage} reports tokenizer coverage statistics for the shared BPE tokenizer (same tokenizer across all runs). The observed subword split rate is very stable across splits, with roughly 1.19 tokens per word.
