...
As our ablation study, we vary the maximum sequence length and compare settings of 64, 128, and 256 tokens. As base models, we take the fine-tuned CNN and LSTM with the best hyperparameters in Table~\ref{tab:hyperparameters}. Using the same base models across all sequence lengths (64, 128, and 256), we study how much context the models need and whether giving them longer input sequences improves performance enough to justify the extra computation.
